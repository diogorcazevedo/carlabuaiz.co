...
export default function OrderReturnFooter() {
        ...
        <>
            <div className="mt-16">
                <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-4 md:gap-x-8 md:gap-y-10 mb-24">
                    ...
                    <div className="relative">
                        <dt>
                            <div className="absolute flex h-12 w-12 p-2 rounded-md bg-indigo-500 text-white">
                    ...
                    <div className="relative">
                        <dt>
                            <div className="absolute flex p-2 h-12 w-12 rounded-md bg-indigo-500 text-white">
                                <svg fill="currentColor" viewBox="0 0 24 24">
                                    <path
                                        fillRule="evenodd"
                            ...
                            <p className="ml-16 text-lg leading-6 font-medium text-gray-900"><a
                                href='https://www.instagram.com/carlabuaizjoias/'> @carlabuaizjoias</a></p>
                        </dt>
                    </div>
                    <div className="relative">
                        <dt>
